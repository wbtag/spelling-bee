...
- English version using [12 dicts](http://wordlist.aspell.net/12dicts/) word list https://github.com/en-wl/wordlist/blob/master/alt12dicts/2of4brif.txt
- Czech version using custom word list compiled from ÚFAL MFF's MorfFlex 2.1 dictionary: https://github.com/wbtag/cs-wordlist
